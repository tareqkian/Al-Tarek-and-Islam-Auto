...
//icontext();
    function hovermenu() {
      /*$(".app-sidebar").hover(()=>{*/
      $(document).on('mouseenter','.app-sidebar',()=>{
        if ($('.app').hasClass('sidenav-toggled')) {
          $('.app').addClass('sidenav-toggled1');
        }
      })
      $(document).on('mouseleave','.app-sidebar',()=>{
        if ($('.app').hasClass('sidenav-toggled')) {
...
//________________Horizontal js
    jQuery(function () {
      ...
      jQuery(function () {
        ...
        // jQuery('#app').addClass("horizontalMenucontainer")
      });
    }());
    ...
    function menuClick() {
      ...
      // $(document).off('click',"[data-bs-toggle='slide']");
      // /* $("[data-bs-toggle='sub-slide']").off('click'); */
      // $(document).off('click',"[data-bs-toggle='sub-slide']");
      // /* $("[data-bs-toggle='sub-slide2']").off('click'); */
      // $(document).off('click',"[data-bs-toggle='sub-slide2']");
